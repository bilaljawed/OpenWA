...
```bash
# Clone and start
git clone https://github.com/A831ARD0/OpenWA_v2.git
cd OpenWA_v2
...
[📖 Documentation](./docs/README.md) · [🔌 API Docs](http://localhost:2785/api/docs) · [🐛 Report Bug](https://github.com/A831ARD0/OpenWA_v2/issues) · [💡 Request Feature](https://github.com/A831ARD0/OpenWA_v2/issues)

<br/>

<sub>Made with ❤️ by the OpenWA Community</sub>
